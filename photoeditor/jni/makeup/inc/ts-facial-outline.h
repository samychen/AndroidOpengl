 ...
 * @param angle     The frontal face is zero degree, and clockwise angle is
 ...
 * @param leye      The center point of the left eye. NOTE: The left is related
 *                  to the zero degree frontal face.
 * @param reye      The center point of the right eye. NOTE: the right is related
 *                  to the zero degree frontal face.
 ...
 */
FacialOutline_EXPORTS TRESULT tsFacialOutline_figure_ex(TSFacialOutline ft, TSOFFSCREEN *image, TRECT faceRect, TPOINT leye, TPOINT reye, TPOINT mouth, TDouble *landmarks, int angle SAK_DEFAULT(0));
