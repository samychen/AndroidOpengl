...
JNIEXPORT jint JNICALL Java_com_cam001_photoeditor_beauty_engine_EditBitmap_native_1create(
...
JNIEXPORT void JNICALL Java_com_cam001_photoeditor_beauty_engine_EditBitmap_native_1destroy(
...
JNIEXPORT void JNICALL Java_com_cam001_photoeditor_beauty_engine_EditBitmap_native_1reset(
		JNIEnv * env, jobject obj, jint handle) {
	AndroidBitmapInfo  info;
	void* pBmpPixels;
	int pixLen;
	...
	Java_com_cam001_photoeditor_beauty_engine_EditBitmap_native_1original(env, obj, handle, JNI_FALSE);
...
JNIEXPORT void JNICALL Java_com_cam001_photoeditor_beauty_engine_EditBitmap_native_1apply(
...
JNIEXPORT void JNICALL Java_com_cam001_photoeditor_beauty_engine_EditBitmap_native_1original(
...
JNIEXPORT void JNICALL Java_com_cam001_photoeditor_beauty_engine_EditBitmap_native_1save(
		JNIEnv * env, jobject obj, jint handle) {
	void* pBmpPixels;
	EditBitmap* pEditBitmap;
	int pixLen;
...
JNIEXPORT void JNICALL Java_com_cam001_photoeditor_beauty_engine_EditBitmap_native_1restore(
		JNIEnv * env, jobject obj, jint handle) {
	void* pBmpPixels;
	EditBitmap* pEditBitmap;
	int pixLen;
