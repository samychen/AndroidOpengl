...
import com.cam001.widget.MatrixAnimation;

public class ScaledDisplayView extends DisplayView 
	...
	public ScaledDisplayView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void transformToIdentify() {
