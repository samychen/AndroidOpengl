...
public class CropOverlayView extends View {
    ...
    private Paint mCornerPaint,mBmpPaint;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mBitmapRect != null && mBitmap != null && !mBitmap.isRecycled())
        	canvas.drawBitmap(mBitmap, null, mBitmapRect, mBmpPaint);
    ...
    private void init(Context context) {
        ...
        strokwidth = mCornerPaint.getStrokeWidth();
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (mFixAspectRatio) {
            ...
            final float horizontalPadding = 0.0f;//0.1f * bitmapRect.width();
            final float verticalPadding = 0.0f;//0.1f * bitmapRect.height();
...
//        canvas.drawLine(left, y2, right, y2, mGuidelinePaint);
    ...
    private void drawCorners(Canvas canvas) {
        ...
        // Top left
//        canvas.drawCircle(left, top, 26.0f, mCornerPaint);
        canvas.drawLine(left-strokwidth,
                        top-strokwidth*3/2,
                        left-strokwidth,
                        top-strokwidth*3/2+ mCornerLength,
                        mCornerPaint);
        canvas.drawLine(left-strokwidth*3/2, top-strokwidth, left-strokwidth*3/2 + mCornerLength, top-strokwidth, mCornerPaint);

        // Top right
//        canvas.drawCircle(right,top,26.0f,mCornerPaint);
        canvas.drawLine(right+strokwidth,
                        top-strokwidth*3/2,
                        right+strokwidth,
                        top-strokwidth*3/2 + mCornerLength,
                        mCornerPaint);
        canvas.drawLine(right+strokwidth*3/2, top-strokwidth, right+strokwidth*3/2 - mCornerLength, top-strokwidth, mCornerPaint);

        // Bottom left
//        canvas.drawCircle(left,bottom, 26.0f, mCornerPaint);
        canvas.drawLine(left-strokwidth,
                        bottom+strokwidth*3/2,
                        left-strokwidth,
                        bottom+strokwidth*3/2- mCornerLength,
                        mCornerPaint);
        canvas.drawLine(left-strokwidth*3/2,
                        bottom+strokwidth,
                        left-strokwidth*3/2 + mCornerLength,
                        bottom+strokwidth,
                        mCornerPaint);

        // Bottom left
//        canvas.drawCircle(right,bottom,26.0f,mCornerPaint);
        canvas.drawLine(right+strokwidth,
                        bottom+strokwidth*3/2,
                        right+strokwidth,
                        bottom+strokwidth*3/2 - mCornerLength,
                        mCornerPaint);
        canvas.drawLine(right+strokwidth*3/2,
                        bottom+strokwidth,
                        right+strokwidth*3/2 - mCornerLength,
                        bottom+strokwidth,
                        mCornerPaint);
