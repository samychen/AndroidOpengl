...
public class TextureFromCameraActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private static class RenderThread extends Thread implements
        ...
        private void updateGeometry() {
            ...
            Log.e(TAG, "updateGeometry: newWidth="+ newWidth+"newHeight="+newHeight);//newWidth=1200newHeight=675纹理图片宽高
            Log.e(TAG, "updateGeometry: mPosX="+mPosX+"mPosY="+mPosY);//mPosX=540.0mPosY=960.0,移动时改变
            Log.e(TAG, "updateGeometry: rotAngle="+ rotAngle);
            Log.e(TAG, "updateGeometry: zoomFactor="+ zoomFactor);//0-1,值越大，图片扩展越大
